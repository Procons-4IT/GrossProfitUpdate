...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OCRD" Or strTab = "OSRN" Or strTab = "OINV" Or strTab = "OHEM" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "ORDR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddFields("OSRN", "Cost", "Item Cost", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
